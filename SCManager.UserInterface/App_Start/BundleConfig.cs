...
namespace SCManager.UserInterface.App_Start
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Content/DataTables/css/datatable").Include("~/Content/DataTables/css/dataTables.bootstrap.min.css", "~/Content/DataTables/css/responsive.bootstrap.min.css", "~/Scripts/DataTables/responsive.bootstrap.min.js"));
            ...
            bundles.Add(new ScriptBundle("~/bundles/TechnicianPerformance").Include("~/Scripts/UserJS/TechnicianPerformance.js"));
            ...
            bundles.Add(new ScriptBundle("~/bundles/TaxBillEntry").Include("~/Scripts/UserJS/TaxBillEntry.js"));
            bundles.Add(new ScriptBundle("~/bundles/ImportForm8").Include("~/Scripts/UserJS/ImportForm8.js"));
